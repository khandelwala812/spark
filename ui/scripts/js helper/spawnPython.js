...
import { getStartAndEndSegments } from './callParser.js';
...
async function main() {
    ...
    obj["recording_url"] = "https://dxc03zgurdly9.cloudfront.net/call_23da1fe02143e5191afa8a62b44/recording.wav"
    console.log((await runPythonAnalysis(obj)));
}
